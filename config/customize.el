...
(custom-set-variables
 ...
 '(package-selected-packages
   '(doom-themes eglot mmm-mode multiple-cursors compat magit drag-stuff gited yaml lsp-mode rust-mode exwm))
...
(custom-set-faces
 ...
 '(dired-directory ((t (:foreground "medium sea green" :weight bold))))
 '(font-lock-comment-face ((t (:foreground "gray50"))))
 '(font-lock-keyword-face ((t (:foreground "#7230A9" :weight bold))))
